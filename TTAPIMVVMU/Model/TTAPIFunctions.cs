...
namespace TTAPI_Init_Worker_XT
{
    ...
    class TTAPIFunctions : IDisposable
    {
        ...
        private void Init()
        {
            ...
            ApiInitializeHandler h = ttApiInitComplete;
        ...
        /// </summary>
        private void ttApiInitComplete(TTAPI api, ApiCreationException ex)
        {
            if (ex == null)
            {
            ...
            {
                Dispose();
                throw new Exception("TT API Initialization Failed: {0}"+ ex.Message);
        ...
        public void m_apiInstance_ConnectionStatusUpdate(object sender, ConnectionStatusUpdateEventArgs e)
        {
            ...
            {
               Dispose();
                throw new Exception("TT API Initialization Failed: {0}"+ e.Status.StatusMessage);
            }
        }
